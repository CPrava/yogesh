		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				...
				<div>
					...
					<form:form action="/springMVC/ProductSearch" method="post">
						...
						<input type="reset"
							class="btn btn-default" value="Clear" onclick="location.href='/springMVC/ProductList'"><br />
						<br />
					</form:form>
					
					<form:form action="/springMVC/ProductDelete" method="post" commandName="productForm">
					<table
						...
						<tr>
							<td><a href="/springMVC/ProductEdit?id=${product.productid}">${product.productid}</a>
							...
							<td><label name="products[${status.index}].manufactureddate">${product.manufactureddate}</label></td>
							...
							<td><label name="products[${status.index}].productname">${product.productname}</label></td>
					...
					<input
						...
						onclick="location.href='/springMVC/ProductAdd'" style="float: right">
					</form:form>
